...
static void makeOpIrrelevant(pddl_strips_t *strips, int op_id,
                             prob_info_t *prob)
{
...
static void removeFact(pddl_strips_t *strips, prob_info_t *prob, int fact_id)
{
