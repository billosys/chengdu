...
ProcessStatus ProcessStatus::from_code(
  StatusCode code,
  Component component,
...
ProcessStatus ProcessStatus::signal_terminated(
  int signal_number,
  Component component,
  SurfaceDisposition surface_disposition) noexcept
{
  return ProcessStatus{
    StatusCode::SignalTerminated,
    component,
    surface_disposition,
    signal_number};
}

StatusCode ProcessStatus::code() const noexcept
{
  return code_;
}

Component ProcessStatus::component() const noexcept
{
  return component_;
}
...
int ProcessStatus::signal_number() const noexcept
{
...
std::string_view surface_disposition_name(
  SurfaceDisposition surface_disposition) noexcept
{
